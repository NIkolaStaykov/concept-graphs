...
def main(cfg : DictConfig):
    ...
    for frame_idx in trange(len(dataset)):
        ...
        if run_detections:
            ...
            # Make the edges            
            labels, edges, edge_image, captions = make_vlm_edges_and_captions(image, curr_det, obj_classes, detection_class_labels, det_exp_vis_path, color_path, cfg.make_edges, None)
